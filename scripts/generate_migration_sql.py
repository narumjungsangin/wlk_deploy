#!/usr/bin/env python3
"""
Generate SQL migration script from crawled data
"""
...
def main():
    ...
    # Generate SQL
    sql_statements = []
    sql_statements.append("-- Migration SQL for legacy data")
    ...
    # Write SQL file
    output_file = Path(__file__).parent / "migration.sql"
    ...
    print(f"2. mysql -u username -p database_name < scripts/migration.sql")
