...
def main():
    ...
    try:
        ...
        # 정보나눔터 게시물
        info_posts = [
            ("피아노 조율", "Mike Bratcher 317-371-5747 웨라에 사는 분은 아니어서 이 분이 웨라에 오실 때 맞춰서 시간 잡고 있어요."),
        ...
        jobs_posts = [
            ...
            ("Admin Officer, 웨스트라피엣 학교", "웨스트라피엣 학교에서 Admin Officer를 채용합니다."),
        ...
        housing_posts = [
            ...
            ("Sk 씨 웨스트라피엣 하우스", "Sk 씨가 하우스 렌트합니다.")
        ]
